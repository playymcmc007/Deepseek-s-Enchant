...
public class DisguiseAndDeceptionCurseEnchantment extends Enchantment {
    ...
    public static class EventHandler {
        @SubscribeEvent
        public static void onItemUsed(PlayerEvent.BreakSpeed event) {
        ...
        private static void checkDurabilityAndReveal(ItemStack stack, LivingEntity entity) {
            if (stack == null || stack.isEmpty()) return;

            if (!EnchantmentHelper.getEnchantments(stack).containsKey(ModEnchantments.DISGUISE_AND_DECEPTION.get())) return;
        ...
        private static void revealCurse(ItemStack stack, LivingEntity entity) {
            if (stack.hasTag()) {
